# macOS App Scaffold — New App flow
...
**Copy `templates/ci/build.yml`** to `.github/workflows/build.yml` and
substitute the placeholders. Do not retype it, and do not write your own from
memory — this file encodes several failures that only surface on a real tagged
release, listed in `templates/ci/README.md`.

```bash
mkdir -p .github/workflows
cp <skill-dir>/templates/ci/build.yml .github/workflows/build.yml
# then replace {{AppName}} / {{SchemeName}} / {{BundleID}} / {{EntitlementsPath}}
```
