    ...
    steps:
      ...
      - name: Import signing certificate
        ...
        run: |
          ...
          # `codesign:` is included because the signing step below invokes
          # codesign directly rather than going through xcodebuild, and the
          # partition list is what decides which tools may use the key. A
          # too-narrow list surfaces as codesign blocking on a GUI prompt no
          # runner can answer. This is the superset a known-good pipeline uses.
